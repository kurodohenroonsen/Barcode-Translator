...
function activateMenuItem() {
    document.getElementById("nav-link_favoris").classList.add("nav-link_actif");
    document.getElementById("nav-link_mobile_favoris").classList.add("nav-link_actif");
}
